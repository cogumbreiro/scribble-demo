...
from ast.argument import pretty_print as argument_pretty_print
...
from ast.roleinstantiationlist import (
    ...
    get_roleinstantiation_children as \
        roleinstantiationlist_get_roleinstantiation_children,
...
def context_visitor_enter(cv, node_):
    ...
    if fullname in do_stack.keys():
        # TODO: global reachability replaced by local projection reachability
